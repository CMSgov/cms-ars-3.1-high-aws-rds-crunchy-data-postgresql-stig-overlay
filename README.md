# cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay
...
```
# How to run
cinc-auditor exec https://github.com/CMSgov/cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay/archive/master.tar.gz --input-file=<path_to_your_inputs_file/name_of_your_inputs_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
mkdir profiles
cd profiles
git clone https://github.com/CMSgov/cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay.git
cinc-auditor archive cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay
...
```
cd cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay
git pull
cd ..
cinc-auditor archive cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay --overwrite
cinc-auditor exec <name of generated archive> --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json>
```
...
To report a bug or feature request, please open an [issue](https://github.com/CMSgov/cms-ars-3.1-high-aws-rds-crunchy-data-postgresql-stig-overlay/issues/new).
